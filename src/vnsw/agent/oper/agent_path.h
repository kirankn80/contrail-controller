...
public:
    ...
    const TagGroupList &tag_list() const {return tag_list_;}
    ...
    void set_tag_list(const TagGroupList &tag) {tag_list_ = tag;}
...
private:
    ...
    const TagGroupList path_tag_list_;
